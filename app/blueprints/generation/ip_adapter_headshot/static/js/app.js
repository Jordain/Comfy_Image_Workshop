(async (window, d, undefined) => {
    ...
    async function load_api_workflows() {
        let wf = {
            'basic_portrait': '/generation/ip_adapter_headshot/static/js/basic_portrait.json',
            'basic_portrait_lcm': '/generation/ip_adapter_headshot/static/js/basic_portrait_lcm.json',
        }
